...
let ContractsController = class ContractsController {
    ...
    update(id, updateContractDto) {
        return this.contractsService.update(Number(id), updateContractDto);
    }
    remove(id) {
        return this.contractsService.remove(Number(id));
    }
};
exports.ContractsController = ContractsController;
__decorate([
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("./entities/contract.entity").Contract }),
...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entities/contract.entity").Contract] }),
    __metadata("design:type", Function),
