...
let Request = class Request {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, employee: { required: true, type: () => require("../../employees/entities/employee.entity").Employee }, type: { required: true, type: () => String }, description: { required: false, type: () => String }, date: { required: true, type: () => Date }, status: { required: true, type: () => Object } };
    }
};
