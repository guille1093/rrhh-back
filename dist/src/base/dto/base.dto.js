...
class PaginationRequestDTO {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { offset: { required: false, type: () => Number, minimum: 0 }, pageSize: { required: false, type: () => Number, minimum: 1, maximum: 100 }, orderBy: { required: false, type: () => String }, orderType: { required: false, type: () => Object } };
    }
}
...
class RoleDto {
    ...
    orderType;
    static _OPENAPI_METADATA_FACTORY() {
        return { offset: { required: false, type: () => Number, minimum: 0 }, limit: { required: false, type: () => Number, minimum: 1, maximum: 100 }, orderBy: { required: false, type: () => String }, orderType: { required: false, type: () => Object, enum: ['ASC', 'DESC'] } };
    }
}
