...
class CreateHolidayDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, date: { required: true, type: () => String }, type: { required: false, type: () => Object } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['NACIONAL', 'EMPRESA'], required: false }),
