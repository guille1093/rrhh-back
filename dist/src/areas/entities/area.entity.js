...
let Area = class Area {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, company: { required: true, type: () => require("../../companies/entities/company.entity").Company }, departments: { required: true, type: () => [require("../../departments/entities/department.entity").Department] } };
    }
};
exports.Area = Area;
__decorate([
